    ...
    <div class="py-12 bg-gray-900 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
                ...
                <!-- Hero Image Section -->
                <div class="relative h-64 sm:h-96 md:h-[500px] overflow-hidden">
                    @if($project->image)
                        <img src="{{ asset($project->image) }}" alt="{{ $project->title }}" class="w-full h-full object-cover">
                    @else
                        <div class="w-full h-full bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center">
                            <svg class="w-20 h-20 sm:w-32 sm:h-32 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-3 w-full sm:w-auto">
                                @if($project->demo_link && $project->demo_link !== '#' && $project->demo_link !== '')
                                    <a href="{{ $project->demo_link }}" target="_blank" rel="noopener noreferrer" class="flex-1 sm:flex-initial inline-flex items-center justify-center px-4 sm:px-5 py-2.5 bg-red-600 hover:bg-red-700 rounded-lg text-white font-medium transition transform hover:scale-105 shadow-lg text-sm sm:text-base">
                                ...
                                @if($project->github_link && $project->github_link !== '#' && $project->github_link !== '')
                                    <a href="{{ $project->github_link }}" target="_blank" rel="noopener noreferrer" class="flex-1 sm:flex-initial inline-flex items-center justify-center px-4 sm:px-5 py-2.5 bg-gray-900 border border-white hover:bg-gray-600 rounded-lg text-white font-medium transition transform hover:scale-105 shadow-lg text-sm sm:text-base">
                ...
                <div class="p-4 sm:p-6 md:p-8">
                    ...
                    <div class="mb-6 sm:mb-8">
                        <h2 class="text-xl sm:text-2xl font-semibold text-white mb-3 sm:mb-4 flex items-center">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 mr-2 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                            </svg>
                            Description
                        </h2>
                        <div class="text-gray-300 leading-relaxed text-justify text-sm sm:text-base">
                    ...
                    <div class="mb-6 sm:mb-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @forelse($project->skills as $skill)
                                <span class="px-2.5 py-1 sm:px-3 sm:py-1.5 bg-gray-700 text-gray-300 rounded-full text-xs sm:text-sm font-medium hover:bg-red-500/20 hover:text-red-400 transition">
                                    {{ $skill->name }}
                                </span>
                            @empty
                                <p class="text-gray-400 text-sm">No technologies listed</p>
                            @endforelse
                        </div>
                    </div>
                    ...
                    @if($project->screenshots && $project->screenshots->count() > 0)
                        ...
                        <div class="mb-6 sm:mb-8">
                            <h2 class="text-xl sm:text-2xl font-semibold text-white mb-3 sm:mb-4 flex items-center">
                                ...
                                Project Gallery
                                <span class="ml-2 text-xs sm:text-sm text-gray-400">({{ $totalImages }} photos)</span>
                            </h2>
                            ...
                            <style>
                                ...
                                @media (max-width: 768px) {
                                    ...
                                    /* Reset all custom grid placements on mobile */
                                    .bento-item {
                                    ...
                                    /* For 3 images - make first one span both columns on mobile */
                                    .bento-item:first-child:nth-last-child(3):first-child {
                                        grid-column: 1 / -1 !important;
                                        min-height: 200px;
                                    }

                                    /* For 5+ images, make the first image span full width on mobile */
                                    .bento-item:first-child:nth-last-child(n+5):first-child {
                                        grid-column: 1 / -1 !important;
                                        min-height: 200px;
                                    }

                                    /* For 6-8 images, make specific images span full width */
                                    .bento-item:first-child:nth-last-child(6) ~ .bento-item:last-child,
                                    .bento-item:first-child:nth-last-child(7) ~ .bento-item:nth-last-child(2),
                                    .bento-item:first-child:nth-last-child(8) ~ .bento-item:nth-last-child(3) {
                                        grid-column: 1 / -1 !important;
                                    }
                                }
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
                                            <div class="absolute bottom-0 left-0 right-0 p-2 sm:p-3">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <svg class="w-4 h-4 sm:w-5 sm:h-5 text-white bg-black/50 rounded-full p-1 backdrop-blur-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="text-center mt-3 sm:mt-4 text-xs text-gray-500">
                    ...
                    <div class="border-t border-gray-700 pt-4 sm:pt-6">
                        <div class="flex flex-wrap gap-4 sm:gap-6 text-xs sm:text-sm text-gray-400">
